...
$Form1 = GUICreate("nhom 4", 615, 437, 192, 124)
	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/1CIulprslmyfTH3u7UpR2EQ0prOQfSXVJqD8anVLWzus/export?format=txt','Keytinsoft.txt')
				Sleep(2000)
				$sodongIP0=_FileCountLines(@ScriptDir&"\Keytinsoft.txt")
				If $sodongIP0<999 Then _requetGooGleDOC('https://docs.google.com/document/d/1CIulprslmyfTH3u7UpR2EQ0prOQfSXVJqD8anVLWzus/export?format=txt','Keytinsoft.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1-3_Jddb780Ja7ACaoz6J2BeV_51k7FVmRp94ixgJt0o/export?format=txt')
				EndIf
				...
				Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/1h191Sk3B_COjS-1EvblFhT0fmM5c8fp9aBXA6_u9IVA/export?format=txt','sokenhsub1luot.txt')
                Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/1YxkIOCzSPpev_oWRnKGDyASf1SCxH_-IoWEAI_yYCXs/export?format=txt','linkkenhchaySUB2.txt')
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 4'&'	vpsso:'&$vpsso,0,0)
				 $checkTG=1
                 $checkchonprofile=0
