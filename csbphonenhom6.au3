...
While 1
	...
	Switch $nMsg
		...
		While 1
			...
			For  $i21=1 to 3
				 _requetGooGleDOC('https://docs.google.com/document/d/1kJIjqEt-UUgb5QTaRKJvtVXiwioPciDpXV6s7CoKW-E/export?format=txt','Keytinsoft3.txt')
				Sleep(2000)
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 6'&'	vpsso:'&$vpsso&'	phien ban:'&$phienban,0,0)
				 $checkTG=1
                 $checkchonprofile=0
