...
$Form1 = GUICreate("nhom 1", 615, 437, 192, 124)
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1BVlDkfJibTbTp7HIQbQ-C2jMVNrItUkX88B6cueKpv4/export?format=txt')
				EndIf
               ...
               Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/1xeBxK9evfG5CbXoUJXFCR2KJGev8Hwt7h4HvjLb4WvU/export?format=txt','linkkenhchaySUB2.txt')
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 1'&'	vpsso:'&$vpsso,0,0)
				$checkTG=1
                 $checkchonprofile=0
