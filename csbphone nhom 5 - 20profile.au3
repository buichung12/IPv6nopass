...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1-fbNZBWh6TZ_pjP6xeeQM_dnBCEnx256QgOVZoz7b6U/export?format=txt')
				EndIf
				...
				_requetGooGleDOC('https://docs.google.com/document/d/1DvKg_sh07GuIfR9bb2eiIlaRCvSfy1_Fn1BqZEpjcVc/export?format=txt','linkkenhchaySUB2.txt')
