...
While 1
	...
	Switch $nMsg
		...
		While 1
			...
			For  $i21=1 to 3
				 _requetGooGleDOC('https://docs.google.com/document/d/1eJ_aOeZ38yytg_bRjHgfFdjLzh_P1698uTVrx5MSAZA/export?format=txt','Keytinsoft3.txt')
				Sleep(2000)
 ...
 For $i5=$profileso to $i7
			...
			;	_requetGooGleDOC('https://docs.google.com/document/d/1shp29rO6RbDVagu_XNDVON07AALpNOxxKke4-Bgma6M/export?format=txt','sokenhsub1luot.txt')
             ;  Sleep(2000)
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 1'&'	vpsso:'&$vpsso&'	phien ban:'&$phienban,0,0)
				$checkTG=1
                 $checkchonprofile=0
