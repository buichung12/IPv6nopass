...
$check=0
    ...
    For $i21=1 to 2                           ; tai chuong trinh chinh
        ...
        If $sonhom=0 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom0.au3"')
		EndIf
		If $sonhom=1 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom1.au3"')
		EndIf
		If $sonhom=2 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom2.au3"')
		EndIf
		If $sonhom=3 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom3.au3"')
		EndIf
		If $sonhom=4 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom4.au3"')
		EndIf
		If $sonhom=5 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom5.au3"')
		EndIf
		If $sonhom=6 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom6.au3"')
		EndIf
		If $sonhom=7 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom7.au3"')
		EndIf
		If $sonhom=8 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom8.au3"')
		EndIf
		If $sonhom=9 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom9.au3"')
		EndIf
		If $sonhom=10 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom10.au3"')
		EndIf
		If $sonhom=11 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom11.au3"')
		EndIf
		If $sonhom=12 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom12.au3"')
		EndIf
		If $sonhom=13 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom13.au3"')
		EndIf
		If $sonhom=14 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom14.au3"')
		EndIf
		If $sonhom=15 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom015.au3"')
		EndIf
		If $sonhom=16 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom16.au3"')
		EndIf
		If $sonhom=17 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom17.au3"')
		EndIf
		If $sonhom=18 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom18.au3"')
		EndIf
		If $sonhom=19 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom19.au3"')
		EndIf
		If $sonhom=20 Then
            _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom20.au3"')
		EndIf
		If $sonhom=21 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom21.au3"')
		EndIf
		If $sonhom=22 Then
           _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/csbphonenhom22.au3"')
		EndIf
	...
	Next
		...
		For $i20=0 to 22
		    FileCopy('C:\Users\'&@UserName&'\Desktop\csbphonenhom'&$i20&'.au3','C:\Users\'&@UserName&'\Desktop\csFireFox - 10 sea',1)
		    Sleep(1000)
		Next
		...
		Sleep(1000)
		_GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/func3.au3"')
        Sleep(10000)
		FileCopy('C:\Users\'&@UserName&'\Desktop\func3.au3','C:\Users\'&@UserName&'\Desktop\csFireFox - 10 sea',1)
		Sleep(1000)


		If FileExists('C:\Users\'&@UserName&'\Desktop\csFireFox - 10 sea\func3.au3')=0 Then
		    _GetDOSOutput('curl -O -L "https://github.com/buichung12/IPv6nopass/blob/main/func3.au3"')
            Sleep(10000)
			FileCopy('C:\Users\'&@UserName&'\Desktop\func3.au3','C:\Users\'&@UserName&'\Desktop\csFireFox - 10 sea',1)
		    Sleep(1000)
