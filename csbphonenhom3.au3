	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				$checkrequet=_requetGooGleDOC('https://docs.google.com/document/d/1fkYnaUDL8Jx7cyuXWqPhok7a56NGKM0kVBL5rglKVx4/export?format=txt','Gmail.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$i20 to 95
                ...
                ToolTip('KenhSo:'&$i5&'	cummay 3'&'	vpsso:'&$vpsso,0,0)
