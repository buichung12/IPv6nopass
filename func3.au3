			  ...
			  For $i10 = 1 to $var[0][0]
			    ...
			    If BitAnd (WinGetState ($var[$i10][1]), 2) And $var[$i10][0] <> "" Then
                    ...
                    If $linkvideo=1 Then
		                ...
		                _ImageSearchArea(@ScriptDir&'\sub2.bmp',1,115, 620,500, 850,$x,$y,1,1)
                        Sleep(500)
						If $x>0 Then
							MouseClick('left',$x,$y,1,20)
							Sleep(5000)
					  ...
					  If $x=0 Then
						...
						_ImageSearchArea(@ScriptDir&'\sub2.bmp',1,75,500,900,850,$x,$y,1,1)
						Sleep(1000)
						If $x>0 Then
							    MouseClick('left',$x,$y,1,20)
							    Sleep(5000)
	...
	EndFunc
		...
		Func _laycodeGmailkhoiphuc($checkcode)
			...
			For $i20=1 to 20
				...
				Sleep(1000)
			Next
			MouseClick('left',330+40, 119+40,1,20)
		    Sleep(2000)
			Send('^a')
			Sleep(1000)
