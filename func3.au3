    ...
    Func _kiemtratrinhduyet($i5,$i,$vpsso,$trusomaybandau)
		...
		$chochay=$vpsso-$trusomaybandau
          ...
          ;  Sleep(1000)
			...
			If $checkupdategmailkhoiphuc2=1 Then
				...
				Sleep(10000)
				_closeTrinhDuyet(1)
				FileCopy('C:\Users\'&@UserName&'\Downloads\emailkhoiphuc2.bmp','C:\Users\'&@UserName&'\Desktop\csFireFox - 10 sea\emailkhoiphuc2.bmp',1)
                Sleep(1000)
		...
		For $i=1 to 10
			  ...
			  For $i2=1 to 2
				...
				If $check=0 Then $check=_loginGmail($i)
				If $check=0 Then
			  ...
			  Next
				...
				If $i=1 Then
					If $check=1 Then $check1=1
				EndIf
				If $i=2 Then
					If $check=1 Then $check2=1
				EndIf
				If $i=3 Then
					If $check=1 Then $check3=1
				EndIf
				If $i=4 Then
					If $check=1 Then $check4=1
				EndIf
				If $i=5 Then
					If $check=1 Then $check5=1
				EndIf
				If $i=6 Then
					If $check=1 Then $check6=1
				EndIf
				If $i=7 Then
					If $check=1 Then $check7=1
				EndIf
				If $i=8 Then
					If $check=1 Then $check8=1
				EndIf
				If $i=9 Then
					If $check=1 Then $check9=1
				EndIf
				If $i=10 Then
					If $check=1 Then $check10=1
				EndIf

			Next

			If $check1=0 Then MsgBox(0,0,'chua dang nhap edge 1',6)
			If $check2=0 Then MsgBox(0,0,'chua dang nhap brave 2',6)
			If $check3=0 Then MsgBox(0,0,'chua dang nhap maxthon 3',6)
			If $check4=0 Then MsgBox(0,0,'chua dang nhap brave por 4',6)
			If $check5=0 Then MsgBox(0,0,'chua dang nhap opera 5',6)
			If $check6=0 Then MsgBox(0,0,'chua dang nhap firefox por 6',6)
			If $check7=0 Then MsgBox(0,0,'chua dang nhap firefox 7',6)
			If $check8=0 Then MsgBox(0,0,'chua dang nhap chromenium 8',6)
			If $check9=0 Then MsgBox(0,0,'chua dang nhap slim 9',6)
			If $check10=0 Then MsgBox(0,0,'chua dang nhap chrome 10',6)
          ...
          For $i2=1 TO 2
			...
			For $i10 = 1 to $var[0][0]
			    If BitAnd (WinGetState ($var[$i10][1]), 2) And $var[$i10][0] <> "" Then
					...
					If $i=1 Then ControlClick($var[$i10][1],'','','left',1,681, 191)
					If $i=2 Then ControlClick($var[$i10][1],'','','left',1,694, 182)
					If $i=3 Then ControlClick($var[$i10][1],'','','left',1,718, 210)
					If $i=4 Then ControlClick($var[$i10][1],'','','left',1,696, 184)
					If $i=5 Then MouseClick('left',706, 200,1,20)
					If $i=6 Then ControlClick($var[$i10][1],'','','left',1,703, 177)
					If $i=7 Then ControlClick($var[$i10][1],'','','left',1,704, 190)
					If $i=8 Then ControlClick($var[$i10][1],'','','left',1,694, 189)
					If $i=9 Then ControlClick($var[$i10][1],'','','left',1,690, 213)
					If $i=10 Then ControlClick($var[$i10][1],'','','left',1,700, 180)
					If $i=10 Then MouseClick('left',700, 190,1,20)
   ...
   EndFunc
	...
	EndFunc
        ...
        Func _loginGmail($i)
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailkhoiphuc2.bmp',1,385, 515,912, 705,$x3,$y3,1)
				If $x3>0 Then
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailkhoiphuc3.bmp',1,385, 515,912, 705,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)   ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailhhoiphuc.bmp',1,385, 515,912, 705,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)    ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailkhoiphuc2.bmp',1,375, 504,916, 688,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)   ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailkhoiphuc3.bmp',1,375, 504,916, 688,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)   ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearch(@ScriptDir&'\emailkhoiphuc.bmp',1,$x3,$y3,0.5)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)   ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearchArea(@ScriptDir&'\emailhhoiphuc.bmp',1,468, 448,583, 555,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)    ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearch(@ScriptDir&'\emailhhoiphuc2.bmp',1,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)    ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
				...
				$x3=0
				$y3=0
				$emailkhoiphuc=_ImageSearch(@ScriptDir&'\emailhhoiphuc3.bmp',1,$x3,$y3,1)
				If $x3>0 Then
					MouseClick('left',$x3,$y3,1,20)    ; click Email khoi phuc
					Sleep(5000)
					For $i20=1 to 10
                ...
                Sleep(2000)
						...
						Send('{enter}')
						Sleep(7000)
						MouseClick('left',600,Random(300,650,1),1,20)     ;chon profile
						Sleep(5000)
						MouseClick('left',500, 60,1,20)
				        ;If $i=8 Then MouseClick('left',800, 75,1,20)
					    Sleep(3000)
						...
						Sleep(12000)
						For $i20=1 to 10
				            $pixcel3=PixelSearch(76, 90,200, 360,0xFF0000)
				            Sleep(1000)
