		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				_CheckUpdateToolupdate('https://docs.google.com/document/d/1PStUUV13AuRmTXwykdKNy4iEaeW3gktWXn56zrUehfQ/export?format=txt')
				 ...
				 $checkrequet=_requetGooGleDOC('https://docs.google.com/document/d/1FVuqyStJx2qg55egvW8keDDtiMZclqbdtyf47O-qvB4/export?format=txt','Gmailtho.txt') ;thay doi theo nhom
                 _LayGmail($vpsso)
				...
				If $sodongIP0<999 Then _requetGooGleDOC('https://docs.google.com/document/d/1iiBohSkxpacCFKmueVTuuj2jktzoquZGI_6IJ_iffII/export?format=txt','Keytinsoft.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1ZjXNciY223zzDEdVTTO-Aj8jy4HVtfKg0RhnaAOm9HY/export?format=txt')        ;thay doi theo nhom
				EndIf
                ...
                Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/1maWaSxFvinrWR8OeCjMj0LJXpYcrJ6zRwLcqo6TpSFo/export?format=txt','linkkenhchaySUB2.txt') ;thay doi theo nhom
