	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				If $sodongIP0<999 Then _requetGooGleDOC('https://docs.google.com/document/d/1T61mEx-oN8kAoQUDempOB7ySkv1O6cF_RlU7d5MDwjw/export?format=txt','Keytinsoft.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 8'&'	vpsso:'&$vpsso,0,0)
				 $checkTG=1
                 $checkchonprofile=0
