	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				$checkrequet=_requetGooGleDOC('https://docs.google.com/document/d/12uNfacfJLTPJsOdGleoy84QSFix2pquxcbITRMRufTM/export?format=txt','Gmail.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$i20 to 95
                ...
                _CapNhatPhienBan()
                 ...
                 ToolTip('KenhSo:'&$i5&'	vpsso:'&$vpsso,0,0)
