	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				If $sodongIP0<999 Then _requetGooGleDOC('https://docs.google.com/document/d/1aiTa6zc4uelXe2eTg_oKZ6VNBC6X-YpYfowcDp51hWk/export?format=txt','Keytinsoft.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1oxx8SXyJqKJqWjBhmy-8cDgQP0TaQDQgJZIHdnuA_Bw/export?format=txt')        ;thay doi theo nhom
				EndIf
	           ...
	           $thoigianDau=0
	  For $i=$Gmailso To 10
                 ToolTip('profile:'&$i5&'	 BLU so:'&$i&'	vongxoay:'&$vongxoaytho&'	nhom kenh:'&$nhomkenh&'	cummay 11'&'	vpsso:'&$vpsso,0,0)
				 $checkTG=1
                 $checkchonprofile=0
