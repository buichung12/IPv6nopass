...
$Form1 = GUICreate("nhom 3", 615, 437, 192, 124)
	...
	Switch $nMsg
		...
		While 1
			   ...
			   $somay=GUICtrlRead($giatriA)
				...
				Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/19daw3mmYlMelhMbkPSgNSH7TCubXIWzuvSO_FsY6g6s/export?format=txt','Keytinsoft.txt')
				Sleep(2000)
				$sodongIP0=_FileCountLines(@ScriptDir&"\Keytinsoft.txt")
				If $sodongIP0<999 Then _requetGooGleDOC('https://docs.google.com/document/d/19daw3mmYlMelhMbkPSgNSH7TCubXIWzuvSO_FsY6g6s/export?format=txt','Keytinsoft.txt')
...
While 1   ; vong tra lai gia tr
 ...
 For $i5=$profileso to $i7
				...
				If FileExists(@ScriptDir&'\checkUpdateCode.txt')=0 Then
				     _CheckUpdateCode('https://docs.google.com/document/d/1EEaMLjyLvSH4oGS-PBNQ4hlumowxkSwwVGDeySZmmvo/export?format=txt')
				EndIf
                ...
                Sleep(2000)
				_requetGooGleDOC('https://docs.google.com/document/d/18ZsgvrdzrHgE3Oq3qOG-b2aL-iryKiRttZHBjx6ufzQ/export?format=txt','linkkenhchaySUB2.txt')
